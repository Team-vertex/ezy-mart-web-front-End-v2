...
const VisionMissionCardTwo: React.FC<VisionMissionCardProps> = ({
  title,
  description,
  iconSrc,
}) => {
  return (
    <article className="flex flex-col sm:flex-row items-center bg-[#E6EFFF] rounded-[0_200px_200px_0] px-6 sm:px-10 py-10 w-full sm:max-w-2xl lg:max-w-[600px] mx-auto">
      <div className="flex-shrink-0 flex items-center justify-center w-24 h-24 sm:w-44 sm:h-44 bg-[#0A65FC] rounded-full mb-6 sm:mb-0 sm:mr-6">
        <img
          src={iconSrc}
          alt={`${title} icon`}
...
export const VisionMissionSection: React.FC = () => {
  return (
    <section className="flex flex-col items-center justify-center px-4 mt-16 lg:flex-row sm:px-8 md:px-16 lg:px-24 xl:px-32">
      <VisionMissionCard
        title="Vision"
