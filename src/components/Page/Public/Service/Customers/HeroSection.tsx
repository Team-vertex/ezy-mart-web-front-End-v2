...
const HeroSection = () => {
  ...
  return (
    ...
    >
      <div className="container flex flex-col items-center justify-center mx-auto pt-36 pb-36 lg:pb-48">
        <motion.h1
          initial={{ opacity: 0, y: 50 }}
          animate={isInView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.6 }}
          className="text-xl font-bold text-center text-white lg:text-6xl"
        >
          Anything, Anywhere
        </motion.h1>
        ...
        <motion.p
          ...
          className="mt-4 text-xs text-center text-white lg:text-2xl"
        >
        ...
        <motion.div
          ...
          className="grid grid-cols-2 mt-4 lg:grid-cols-4 md:gap-8"
        >
        ...
        <motion.button
          ...
          className="bg-[#15366B] text-white font-semibold text-sm lg:text-lg px-4 py-2 rounded-full mt-8 hover:bg-[#15366B]/80 transition-colors"
        >
          See How It Works
        </motion.button>
      </div>
